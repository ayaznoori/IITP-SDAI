...
flowchart TB
    subgraph foundation ["Foundation"]
        P1["<b>Previous Module</b><br/>Module 2: Web Fundamentals<br/><i>[HTML · CSS]</i><br/>Page structure and design"]
        CM["<b>Current Module Until Previous Session</b><br/>Module 2: Web Fundamentals<br/><i>[JS Basics]</i><br/>Variables · loops · objects in browser"]
    end
    subgraph current ["Current Session"]
        CS["<b>Current Session</b><br/>JavaScript Fundamentals II<br/><i>Mental shift:</i> <b>inline scripts</b> → <b>reusable functions</b><br/>Scope · refactor · structured data"]
    end
    subgraph value ["Course & Real-Life Value"]
        CV["<b>Course Value</b><br/>Maintainable JS before modern syntax<br/>Functions mirror React components"]
        RL["<b>Real-Life Use</b><br/>Shared validators · Pricing helpers · Cart logic"]
    end
    subgraph future ["Upcoming Modules"]
        U1["<b>Upcoming Module</b><br/>Module 2: Web Fundamentals<br/><i>[Modern JS]</i><br/>map · filter · reduce"]
        U2["<b>Upcoming Module</b><br/>Module 2: Web Fundamentals<br/><i>[DOM · Async]</i><br/>Interactive apps"]
        U3["<b>Upcoming Module</b><br/>Module 2: Web Fundamentals<br/><i>[React]</i><br/>Declarative UI"]
    end
    P1 ==>|&nbsp;Foundation&nbsp;| CM
    CM ==>|&nbsp;Builds on&nbsp;| CS
    CS ==>|&nbsp;Course Path&nbsp;| CV
